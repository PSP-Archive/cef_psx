...
typedef struct
{
	...
	int umdmode;
	int fakeregion;
	int fixexploitsavedata;
	int hideexploitgame;
	int hidedlcs;
	int hidevolumebar;
	int hidenonworkingitems;
	int hidepic0pic1;
	...
	int homebuttoncombo1;
	int homebuttoncombo2;
	int notebuttoncombo1;
	int notebuttoncombo2;
	int notusevshplugins;
 ...
 *
 * @param config - pointer to a TNConfig structure that receives the SE configuration
 ...
 *
 * @param config - pointer to a TNConfig structure that has the SE configuration to set
 * @returns 0 on success
*/
